                        ...
                        <div class="swiper-container" data-effect="fade">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-details-img-wrap swiper-slide">
                                    <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" data-swiper-parallax="-10">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                    <div class="product-details-info">
                        ...
                        <form action="{{ route('cart.add') }}" method="POST">
                            @csrf
                            <div class="quantity">
                                <a href="#" class="quantity-minus cart-decrement">-</a>
                                <input name="qty" title="Qty" class="email input-text qty text" type="text" value="2">
                                <a href="#" class="quantity-plus cart-increment">+</a>
                            </div>
