            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="cart">
                            <h1 class="cart-title">
                                In Your Shopping Cart: <span class="c-primary">{{ Cart::content()->count() }} items</span>
                            </h1>
                        </div>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <div class="cart-product__item">
                                                    <a href="#">
                                                        <img src="{{ $product->model->image }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                    </a>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity">
                                                    <a href="{{ route('cart.decrement', ['id' => $product->rowId, 'qty' => $product->qty]) }}" class="quantity-minus">-</a>
                                                    <input title="Qty" class="email input-text qty text" type="text" placeholder="{{ $product->qty }}" readonly>
                                                    <a href="{{ route('cart.increment', ['id' => $product->rowId, 'qty' => $product->qty]) }}" class="quantity-plus">+</a>
                                                </div>
                                            </td>
